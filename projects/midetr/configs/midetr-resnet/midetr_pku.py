...
lr_multiplier = get_config("common/coco_schedule.py").lr_multiplier
train = get_config("common/train.py").train

# modify training config
#train.init_checkpoint = "detectron2://ImageNetPretrained/torchvision/R-50.pkl"
train.output_dir = "output/pku/trans"

#resume train
#train.init_checkpoint = "/home/liushuai/wky/DFFT/MI-DETR/output/pku/private_boost/model_0079999.pth"
train.resume = True
...
train.checkpointer.period = 4000
